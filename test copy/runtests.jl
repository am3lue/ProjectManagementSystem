...
# !!! Main.UserApp is configured as an alias for Main.PMS and you might encounter it in some tests
using Main.PMS, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "PMS tests" begin
  @includetests ARGS
end
