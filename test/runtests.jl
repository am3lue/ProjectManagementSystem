...
# !!! Main.UserApp is configured as an alias for Main.ProjectManagementSystem and you might encounter it in some tests
using Main.ProjectManagementSystem, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "ProjectManagementSystem tests" begin
  @includetests ARGS
end
